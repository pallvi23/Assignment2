...
# Sort data by NFSA Card Type to group them together (AAY, PHH, NPHH)
df_combined.sort_values(by="NFSA Card Type", inplace=True)

# Reset index after sorting
df_combined.reset_index(drop=True, inplace=True)

# Save the sorted data to a single CSV file
df_combined.to_csv("card_type.csv", index=False, encoding='utf-8')
print(f"Data saved in card_type.csv")
